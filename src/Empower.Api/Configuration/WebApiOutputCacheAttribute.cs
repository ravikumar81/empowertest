...
namespace Empower.Api.Configuration
{
    public class WebApiOutputCacheAttribute : ActionFilterAttribute
    {
        ...
        private bool _isCacheable(System.Web.Http.Controllers.HttpActionContext ac)
        {
        ...
        public override void OnActionExecuting(System.Web.Http.Controllers.HttpActionContext ac)
        {
            if (ac != null)
            {
                if (_isCacheable(ac))
