...
{
    public class UnitOfWorkAndLoggerAttribute : ActionFilterAttribute
    {

        public override void OnActionExecuting(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            var unitOfWorkManager = (IManageUnitsOfWork)actionContext.Request.GetDependencyScope().GetService(typeof(IManageUnitsOfWork));
        ...
        {
            IManageUnitsOfWork unitOfWorkManager = (IManageUnitsOfWork)actionExecutedContext.Request.GetDependencyScope().GetService(typeof(IManageUnitsOfWork));
            if (unitOfWorkManager != null)
            {
                unitOfWorkManager.End(actionExecutedContext.Exception);
            }
